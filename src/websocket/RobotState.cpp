...
void RobotState::setJointPosition(const double& joint_position, size_t joint)
{
  ...
  // std::cout << "setJointPositions: jnt " << joint << " updated to " <<
  // joint_position*m_input_to_rad_factor << std::endl;
}
...
// void RobotState::setState(const std::vector<double> &joint_positions,const std::vector<double>
